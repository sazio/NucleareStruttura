...
void EfficienzaI()
{
    ...
    float HV[]  = {1396, 1447, 1497, 1547, 1572, 1597, 1622, 1647, 1697};
    float sHV[] = {1, 1, 1, 1, 1, 1, 1, 1, 1};
    
    float N_tripla[] = {55, 136, 269, 389, 447, 458,440, 480, 524 };
    ...
    float N_doppia[]  ={501, 461, 489, 476, 510, 494, 465, 510, 536  };
