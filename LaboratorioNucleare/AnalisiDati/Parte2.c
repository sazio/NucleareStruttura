...
void Parte2()
{
   ...
   // const double pi = 3.141592654 ;
    ...
    float Spessore[]  = {0,1.316,3.6 };   //Considerato il dato di rob, consistente ma fa uscire la misura dalla probabilita?
    float sSpessore[] = {0.011,0.022,0.088};
    ...
    ExtinctionCoefficient -> SetParameter(0,0.5);
    ExtinctionCoefficient -> SetParameter(1,-0.17);
