...
void Parte2conRob()
{
   ...
   // const double pi = 3.141592654 ;
    ...
    float Spessore[]  = {0,1.316,2.066, 3.6 };   //Considerato il dato di rob, consistente ma fa uscire la misura dalla probabilita?
    float sSpessore[] = {0.011,0.022,0.044,0.088};
    float R_Flusso[]  = {0.5502, 0.3965,0.3846, 0.2865}; // Tutte con distanza 30 cm tra i moduli della cosmic box
    float sR_Flusso[] = {0.0229, 0.0125,0.0122, 0.0088};
