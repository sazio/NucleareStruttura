...
void DimensioneAtomica_NaCl(){
    ...
    //numero misure
    const int nmisure =  74 ;
    
    
    // numero misure senza doppi
    const int nmisure2= 37 ;
    //----- DATI ------
    ...
    float Conteggi[] = {29, 47, 25, 14, 22, 29, 29, 13, 29, 34,
                        42, 41, 31, 34, 28, 35, 38, 33, 31, 35,
                        31, 45, 34, 39, 34, 44, 42, 39, 34, 42,
        
                        22, 33, 31, 31, 36, 28, 46, 42, 30, 41,
                        35, 30 , 36, 48, 51, 55, 79, 64, 90, 87,
                        122, 134, 145, 150, 134, 179, 143, 146, 128, 123,
        
                        97, 101, 56, 46, 47, 40, 33, 44, 31, 40,
                        47, 46, 38, 29
    ...
    float ThetaX2[]  = {12, 12, 13, 13, 14, 14, 15, 15, 16, 16,
                        ...
                        27, 27, 28, 28, 28.33, 28.33, 28.67, 28.67, 29, 29,
                        30, 30, 30.5, 30.5, 30.67, 30.67, 30.83, 30.83, 31, 31,
    ...
    fitFcn->SetParameter(4, 1); // Constant - pol evaluated in get position x
    fitFcn->SetParameter(5, 28.63 ); // Mean
    ...
    fitFcn->SetParameter(6, 0.45 );//, 32.90); // Width - rough order of mag estimate
